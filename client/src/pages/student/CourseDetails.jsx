...
//   }
 // is used to open and close the sections
  ...
  return courseData ? (
    <>
      <div className="flex md:flex-row flex-col-reverse gap-10 relative items-start justify-between px-4 sm:px-8 md:px-12 lg:px-16 max-w-7xl mx-auto w-full pt-6 md:pt-10 text-left">
